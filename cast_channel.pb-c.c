...
{
  static const Extensions__Api__CastChannel__CastMessage init_value = EXTENSIONS__API__CAST_CHANNEL__CAST_MESSAGE__INIT;
  *message = init_value;
}
...
{
  static const Extensions__Api__CastChannel__AuthChallenge init_value = EXTENSIONS__API__CAST_CHANNEL__AUTH_CHALLENGE__INIT;
  *message = init_value;
}
...
{
  static const Extensions__Api__CastChannel__AuthResponse init_value = EXTENSIONS__API__CAST_CHANNEL__AUTH_RESPONSE__INIT;
  *message = init_value;
}
...
{
  static const Extensions__Api__CastChannel__AuthError init_value = EXTENSIONS__API__CAST_CHANNEL__AUTH_ERROR__INIT;
  *message = init_value;
}
...
{
  static const Extensions__Api__CastChannel__DeviceAuthMessage init_value = EXTENSIONS__API__CAST_CHANNEL__DEVICE_AUTH_MESSAGE__INIT;
  *message = init_value;
}
...
static const Extensions__Api__CastChannel__SignatureAlgorithm extensions__api__cast_channel__auth_challenge__signature_algorithm__default_value = EXTENSIONS__API__CAST_CHANNEL__SIGNATURE_ALGORITHM__RSASSA_PKCS1v15;
static const ProtobufCFieldDescriptor extensions__api__cast_channel__auth_challenge__field_descriptors[1] =
{
  {
    "signature_algorithm",
    1,
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_ENUM,
    offsetof(Extensions__Api__CastChannel__AuthChallenge, has_signature_algorithm),
    offsetof(Extensions__Api__CastChannel__AuthChallenge, signature_algorithm),
    &extensions__api__cast_channel__signature_algorithm__descriptor,
    &extensions__api__cast_channel__auth_challenge__signature_algorithm__default_value,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
};
static const unsigned extensions__api__cast_channel__auth_challenge__field_indices_by_name[] = {
  0,   /* field[0] = signature_algorithm */
};
static const ProtobufCIntRange extensions__api__cast_channel__auth_challenge__number_ranges[1 + 1] =
{
  { 1, 0 },
  { 0, 1 }
};
const ProtobufCMessageDescriptor extensions__api__cast_channel__auth_challenge__descriptor =
{
  ...
  1,  extensions__api__cast_channel__auth_challenge__number_ranges,
  (ProtobufCMessageInit) extensions__api__cast_channel__auth_challenge__init,
  NULL,NULL,NULL    /* reserved[123] */
};
static const Extensions__Api__CastChannel__SignatureAlgorithm extensions__api__cast_channel__auth_response__signature_algorithm__default_value = EXTENSIONS__API__CAST_CHANNEL__SIGNATURE_ALGORITHM__RSASSA_PKCS1v15;
static const ProtobufCFieldDescriptor extensions__api__cast_channel__auth_response__field_descriptors[4] =
{
  {
    "signature",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_BYTES,
    offsetof(Extensions__Api__CastChannel__AuthResponse, n_intermediate_certificate),
    offsetof(Extensions__Api__CastChannel__AuthResponse, intermediate_certificate),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_ENUM,
    offsetof(Extensions__Api__CastChannel__AuthResponse, has_signature_algorithm),
    offsetof(Extensions__Api__CastChannel__AuthResponse, signature_algorithm),
    &extensions__api__cast_channel__signature_algorithm__descriptor,
    &extensions__api__cast_channel__auth_response__signature_algorithm__default_value,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
};
...
static const ProtobufCEnumValue extensions__api__cast_channel__auth_error__error_type__enum_values_by_number[3] =
{
  ...
  { "SIGNATURE_ALGORITHM_UNAVAILABLE", "EXTENSIONS__API__CAST_CHANNEL__AUTH_ERROR__ERROR_TYPE__SIGNATURE_ALGORITHM_UNAVAILABLE", 2 },
};
static const ProtobufCIntRange extensions__api__cast_channel__auth_error__error_type__value_ranges[] = {
{0, 0},{0, 3}
};
static const ProtobufCEnumValueIndex extensions__api__cast_channel__auth_error__error_type__enum_values_by_name[3] =
{
  { "INTERNAL_ERROR", 0 },
  { "NO_TLS", 1 },
...
static const ProtobufCEnumValue extensions__api__cast_channel__signature_algorithm__enum_values_by_number[3] =
{
  { "UNSPECIFIED", "EXTENSIONS__API__CAST_CHANNEL__SIGNATURE_ALGORITHM__UNSPECIFIED", 0 },
  { "RSASSA_PKCS1v15", "EXTENSIONS__API__CAST_CHANNEL__SIGNATURE_ALGORITHM__RSASSA_PKCS1v15", 1 },
  { "RSASSA_PSS", "EXTENSIONS__API__CAST_CHANNEL__SIGNATURE_ALGORITHM__RSASSA_PSS", 2 },
};
static const ProtobufCIntRange extensions__api__cast_channel__signature_algorithm__value_ranges[] = {
{0, 0},{0, 3}
};
static const ProtobufCEnumValueIndex extensions__api__cast_channel__signature_algorithm__enum_values_by_name[3] =
{
  { "RSASSA_PKCS1v15", 1 },
  { "RSASSA_PSS", 2 },
  { "UNSPECIFIED", 0 },
};
const ProtobufCEnumDescriptor extensions__api__cast_channel__signature_algorithm__descriptor =
{
  PROTOBUF_C__ENUM_DESCRIPTOR_MAGIC,
  "extensions.api.cast_channel.SignatureAlgorithm",
  "SignatureAlgorithm",
  "Extensions__Api__CastChannel__SignatureAlgorithm",
  "extensions.api.cast_channel",
  3,
  extensions__api__cast_channel__signature_algorithm__enum_values_by_number,
  3,
  extensions__api__cast_channel__signature_algorithm__enum_values_by_name,
  1,
  extensions__api__cast_channel__signature_algorithm__value_ranges,
  NULL,NULL,NULL,NULL   /* reserved[1234] */
};
